...
import Features9 from "./features.react/features9";

export const componentFeatures9: Component = {
  id: 'features9',
  name: 'Features 9',
  description: 'Server Component',
  category: 'features',
  component: Features9,
  code: `import { MdOutlineAccessibilityNew, MdOutlineApi, MdOutlineDashboardCustomize, MdOutlineEventAvailable, MdOutlinePayment, MdOutlineTaskAlt } from "react-icons/md";
