...
import Features2 from "./features.react/features2";

export const componentFeatures2: Component = {
  id: 'features2',
  name: 'Features 2',
  description: 'Server Component',
  category: 'features',
  component: Features2,
  code: `import { MdOutlineSettings, MdOutlineBuild, MdOutlineCloud, MdOutlineAnalytics, MdOutlinePalette, MdOutlineSupport } from "react-icons/md";
