...
import Features5 from "./features.react/features5";

export const componentFeatures5: Component = {
  id: 'features5',
  name: 'Features 5',
  description: 'Server Component',
  category: 'features',
  component: Features5,
  code: `import { MdOutlineDeveloperMode, MdOutlineMemory, MdOutlineNetworkCheck, MdOutlineWidgets, MdOutlineDataUsage, MdOutlineCloudSync } from "react-icons/md";
