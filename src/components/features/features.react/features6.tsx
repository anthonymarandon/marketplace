import { MdOutlineDesignServices, MdOutlineAppRegistration, MdOutlineSystemUpdateAlt, MdQueryStats, MdOutlineSupport, MdOutlineVerifiedUser } from "react-icons/md";
