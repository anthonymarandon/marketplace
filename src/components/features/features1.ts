...
import Features1 from "./features.react/features1";

export const componentFeatures1: Component = {
  id: 'features1',
  name: 'Features 1',
  description: 'Server Component',
  category: 'features',
  component: Features1,
  code: `import { MdSpeed, MdSecurity, MdIntegrationInstructions, MdAutoAwesome, MdInsights, MdSupportAgent } from "react-icons/md";
