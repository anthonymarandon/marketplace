...
import Features7 from "./features.react/features7";

export const componentFeatures7: Component = {
  id: 'features7',
  name: 'Features 7',
  description: 'Server Component',
  category: 'features',
  component: Features7,
  code: `import { MdOutlineCheck, MdOutlineIntegrationInstructions, MdOutlineAutoGraph, MdOutlineManageAccounts, MdOutlinePhonelinkSetup } from "react-icons/md";
