...
import Features8 from "./features.react/features8";

export const componentFeatures8: Component = {
  id: 'features8',
  name: 'Features 8',
  description: 'Server Component',
  category: 'features',
  component: Features8,
  code: `import { MdOutlineBolt, MdOutlineStorage, MdAutorenew, MdCloudQueue } from "react-icons/md";
