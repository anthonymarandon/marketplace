...
import form4  from "./form.react/form4";

export const componentForm4: Component = {
  id: 'form4',
  name: 'form4',
...
export default function Form4() {
  ...
  return (
    <div id="form" className="bg-gradient-to-br from-green-100 to-emerald-200">
      <div className="w-full py-20 px-6 md:px-8">
        <div className="mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-5 text-green-700">
            Entrons en contact
          </h2>
          <div className="w-28 h-0.5 bg-gradient-to-r from-green-500 to-emerald-400 mx-auto mb-12 rounded-full"></div>
          ...
          <form onSubmit={handleSubmit} className="max-w-[700px] mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-xl relative">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      type="text" 
                      id="firstName" 
                      className="w-full p-3.5 pl-4 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  <textarea 
                    id="message" 
                    rows={5} 
                    className="w-full p-4 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 resize-none"
            ...
            <div className={\`transition-opacity duration-500 $\{isSubmitted ? 'opacity-100' : 'opacity-0 pointer-events-none'} absolute inset-0 flex items-center justify-center\`}>
              <h3 className="text-3xl font-semibold text-green-600">Merci pour votre message</h3>
            </div>
          </form>
        </div>
      </div>
