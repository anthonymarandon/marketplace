...
import Footer4 from "./footer.react/footer4";

export const componentFooter4: Component = {
  id: 'footer4',
  name: 'Footer 4',
  description: 'Server Component',
  category: 'footer',
  component: Footer4,
  code: `import { FaTwitter, FaLinkedinIn, FaGithubAlt, FaDribbble } from 'react-icons/fa';
