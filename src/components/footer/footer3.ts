...
import Footer3 from "./footer.react/footer3";

export const componentFooter3: Component = {
  id: 'footer3',
  name: 'Footer 3',
  description: 'Server Component',
  category: 'footer',
  component: Footer3,
  code: `import { FaPinterestP, FaRedditAlien, FaWhatsapp, FaSnapchatGhost } from 'react-icons/fa';
