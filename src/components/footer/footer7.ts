...
import Footer7 from "./footer.react/footer7";

export const componentFooter7: Component = {
  id: 'footer7',
  name: 'Footer 7',
  description: 'Server Component',
  category: 'footer',
  component: Footer7,
  code: `import { FaFacebookF, FaTwitter, FaInstagram, FaYoutube } from 'react-icons/fa';
