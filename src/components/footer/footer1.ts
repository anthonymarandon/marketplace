...
import Footer1 from "./footer.react/footer1";

export const componentFooter1: Component = {
  id: 'footer1',
  name: 'Footer 1',
  description: 'Server Component',
  category: 'footer',
  component: Footer1,
  code: `import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn } from 'react-icons/fa';
import { FiMapPin, FiPhone, FiMail, FiSend } from 'react-icons/fi';

export default function Footer1() {
  return (
    <footer className="bg-white text-gray-700 py-12 px-4 sm:px-6 lg:px-8 max-w-full mx-auto">
