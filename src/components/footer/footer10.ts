...
import Footer10 from "./footer.react/footer10";

export const componentFooter10: Component = {
  id: 'footer10',
  name: 'Footer 10',
  description: 'Server Component',
  category: 'footer',
  component: Footer10,
  code: `import { FiFacebook, FiInstagram, FiTwitter, FiLinkedin } from 'react-icons/fi';
