...
import Footer5 from "./footer.react/footer5";

export const componentFooter5: Component = {
  id: 'footer5',
  name: 'Footer 5',
  description: 'Server Component',
  category: 'footer',
  component: Footer5,
  code: `import { FaFacebookSquare, FaInstagramSquare, FaTwitterSquare } from 'react-icons/fa';
