...
import Testimonials8 from "./testimonials.react/testimonials8";

export const componentTestimonials8: Component = {
  id: 'testimonials8',
  name: 'Testimonials 8',
  description: 'Server Component',
  category: 'testimonials',
  component: Testimonials8,
  code: `export default function Testimonials8() {
  return (
