...
import Testimonials9 from "./testimonials.react/testimonials9";

export const componentTestimonials9: Component = {
  id: 'testimonials9',
  name: 'Testimonials 9',
  description: 'Server Component',
  category: 'testimonials',
  component: Testimonials9,
  code: `export default function Testimonials9() {
  return (
