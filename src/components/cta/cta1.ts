...
import CTA1 from './cta.react/cta1';

export const componentCTA1: Component = {
  id: 'cta1',
  name: 'CTA 1',
  description: 'Server Component',
  category: 'cta',
  component: CTA1,
  code: `    import { FaApple, FaWindows, FaGoogle, FaAmazon, FaSpotify, FaHeadset, FaArrowRight, FaPlayCircle } from 'react-icons/fa';
    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <img
                ...
                style={{ aspectRatio: '4/3' }} // Ajustez si nécessaire
            />
