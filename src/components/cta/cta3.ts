...
import CTA3 from './cta.react/cta3';

export const componentCTA3: Component = {
  id: 'cta3',
  name: 'CTA 3',
  description: 'Server Component',
  category: 'cta',
  component: CTA3,
  code: `import { FaRegLightbulb, FaRegComments, FaRegCheckCircle } from 'react-icons/fa';
...
export default function CTA3() {
  ...
  return (
    <div className="bg-gray-100 p-8 md:p-16 max-w-7xl mx-auto shadow font-sans text-center">
