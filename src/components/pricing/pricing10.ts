...
import Pricing10 from "./pricing.react/pricing10";

export const componentPricing10: Component = {
  id: 'pricing10',
  name: 'Pricing 10',
  description: 'Server Component',
  category: 'pricing',
  component: Pricing10,
  code: `import { FiBox, FiUsers, FiCheck, FiPlusCircle } from 'react-icons/fi';
