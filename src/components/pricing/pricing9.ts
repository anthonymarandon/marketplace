...
import Pricing9 from "./pricing.react/pricing9";

export const componentPricing9: Component = {
  id: 'pricing9',
  name: 'Pricing 9',
  description: 'Server Component',
  category: 'pricing',
  component: Pricing9,
  code: `import { FiCheckCircle, FiLock, FiDatabase, FiCpu, FiPieChart, FiArrowRightCircle } from 'react-icons/fi';
