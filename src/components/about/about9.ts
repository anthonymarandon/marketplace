...
import About9 from './about.react/about9';

export const componentAbout9: Component = {
  id: 'about9',
  name: 'About 9',
  description: 'Server Component',
  category: 'about',
  component: About9,
  code: `import { IoBuildOutline, IoBusinessOutline, IoHandRightOutline, IoChatbubblesOutline, IoPeopleOutline, IoCheckmarkCircleOutline, IoBarChartOutline } from 'react-icons/io5';
