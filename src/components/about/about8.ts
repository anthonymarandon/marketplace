...
import About8 from './about.react/about8';

export const componentAbout8: Component = {
  id: 'about8',
  name: 'About 8',
  description: 'Server Component',
  category: 'about',
  component: About8,
  code: `import { IoSparklesOutline, IoPeopleCircleOutline, IoHandLeftOutline, IoColorPaletteOutline, IoSyncCircleOutline, IoHeartOutline, IoStarOutline, IoLockClosedOutline } from 'react-icons/io5';
