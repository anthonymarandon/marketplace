import { IoRocketOutline, IoLeafOutline, IoSchoolOutline, IoArrowForwardCircleOutline, IoCodeSlashOutline, IoColorWandOutline, IoPeopleOutline } from 'react-icons/io5';
