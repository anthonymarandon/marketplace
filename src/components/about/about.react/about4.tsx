import { IoStatsChartOutline, IoSparklesOutline, IoCalendarOutline, IoRibbonOutline, IoBuildOutline, IoPeopleOutline, IoCheckmarkCircleOutline } from 'react-icons/io5';
